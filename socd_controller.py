...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.duration_label = QLabel("反向补偿时长")
        ...
        duration_header.addWidget(self.duration_label)
    ...
    def _load_controls(self) -> None:
        ...
        self._set_duration_controls_enabled(settings.enabled and settings.mode == "duration")
    ...
    def _set_duration_controls_enabled(self, enabled: bool) -> None:
    ...
    def _controls_changed(self, *args) -> None:
        ...
        self._set_duration_controls_enabled(enabled and self.settings.mode == "duration")
...
QLabel#sectionLabel:disabled { color: #6f7680; }
QPushButton#segment {
  min-height: 38px;
  border: 0;
  border-radius: 19px;
...
QSlider::groove:horizontal:disabled { background: #343941; }
QSlider::sub-page:horizontal:disabled { background: #5f6670; }
QSlider::handle:horizontal:disabled { background: #8b929b; border: 2px solid #5f6670; }
QSpinBox {
  min-height: 30px;
